...
`,Xy=()=>{const[e,t]=V.useState(!1),n=()=>t(r=>!r);return w.jsxs(By,{children:[w.jsx(Hy,{src:Lv,alt:"logo image"}),w.jsx(Wy,{icon:Wv,onClick:n}),w.jsx(Vy,{$menu:e,children:w.jsxs(Yy,{children:[w.jsx(_r,{children:w.jsx(ea,{href:"#",children:"Features"})}),w.jsx(_r,{children:w.jsx(ea,{href:"#",children:"Pricing"})}),w.jsx(_r,{children:w.jsx(ea,{href:"#",children:"Resources"})}),w.jsx(_r,{children:w.jsx(Ky,{})}),w.jsx(_r,{children:w.jsx(ea,{href:"#",children:"Login"})}),w.jsx(Qy,{children:w.jsx(Gy,{href:"#",children:"Sign Up"})})]})})]})},Zy="/url-shortening-api/assets/illustration-working-fae884c2.svg",Jy=A(vr)`
...
`,r2=()=>w.jsxs(Jy,{children:[w.jsx(qy,{src:Zy,alt:"illustration working"}),w.jsx(e2,{children:"More than just shorter links"}),w.jsx(t2,{children:"Build your brand’s recognition and get detailed insights on how your links are performing."}),w.jsx(n2,{as:"a",href:"#shortening",children:"Get Started"})]}),i2="/url-shortening-api/assets/bg-shorten-desktop-d119628f.svg",a2="/url-shortening-api/assets/bg-shorten-mobile-53ca2a05.svg",o2=e=>V.createElement("svg",{width:15,height:15,xmlns:"http://www.w3.org/2000/svg",...e},V.createElement("path",{d:"M11.314 0l2.828 2.828L9.9 7.071l4.243 4.243-2.828 2.828L7.07 9.9l-4.243 4.243L0 11.314 4.242 7.07 0 2.828 2.828 0l4.243 4.242L11.314 0z",fill:"#000",fillRule:"evenodd",opacity:.4})),l2=A(vr)`
  background: white;
...
`,p2=({storedItems:e,setStoredItems:t,buttonIndex:n,setButtonIndex:r})=>{const i=o=>{localStorage.removeItem(`${e[o].code}`);const l=e.toSpliced(o,1);t(l)},a=o=>{r(o);const l=e[o].shortLink;navigator.clipboard.writeText(l)};return w.jsx(w.Fragment,{children:e.map((o,l)=>{if(o.originalLink!=="")return w.jsxs(l2,{children:[w.jsx(s2,{onClick:()=>{i(l)}}),w.jsx(u2,{children:o.originalLink}),w.jsx(c2,{}),w.jsx(f2,{children:o.shortLink}),w.jsx(d2,{onClick:()=>{a(l)},$backgroundColor:n===l?"Copied!":"Copy",children:n===l?"Copied!":"Copy"})]},o.code)})})},m2=A(vr)`
...
`,x2=()=>{const[e,t]=V.useState(""),n=P=>t(P.target.value),r=/^(http(s):\/\/.)[-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_+.~#?&//=]*)$/g,[i,a]=V.useState(null),o=V.useRef(null),[l,s]=V.useState(null),[u,d]=V.useState(0),m=()=>{d(P=>P+1),o.current.focus(),s(null),r.test(e)?a(null):a("Please add a link")};let h=[];for(let P=0;P<localStorage.length;P++){const f=localStorage.key(P),c=JSON.parse(localStorage.getItem(f));h.push(c)}const[v,y]=V.useState([...h]);V.useEffect(()=>{let P=!0;return fetch(`https://api.shrtco.de/v2/shorten?url=${e}`).then(f=>f.json()).then(f=>{if(P&&!i)if(f.ok){const c=f.result.code,p={code:c,originalLink:f.result.original_link,shortLink:f.result.full_short_link};y([p,...v]),localStorage.setItem(`${c}`,JSON.stringify(p)),t("")}else!f.ok&&f.error_code!==1&&a(`Failed to shorten URL: "${f.disallowed_reason}"`)}),()=>P=!1},[u]);const k=()=>{localStorage.clear(),y([]),t("")};return w.jsxs(m2,{children:[w.jsx(h2,{children:w.jsxs(v2,{id:"shortening",children:[w.jsx(g2,{type:"url",placeholder:"Shorten a link here...",id:"input",value:e,onChange:n,ref:o,$error:i}),w.jsx(y2,{$error:i,children:i}),w.jsx(w2,{onClick:m,$error:i,children:"Shorten It!"})]})}),w.jsx(p2,{storedItems:v,setStoredItems:y,buttonIndex:l,setButtonIndex:s}),v.length>=2&&w.jsx(k2,{onClick:k,children:"Clear All Results!"})]})},S2="/url-shortening-api/assets/icon-brand-recognition-eff49c7b.svg",E2="/url-shortening-api/assets/icon-detailed-records-4d8ad978.svg",C2="/url-shortening-api/assets/icon-fully-customizable-56af2809.svg",P2=A(vr)`
  background-color: var(--light-gray);
  text-align: center;
...
`,N2=()=>w.jsxs(P2,{children:[w.jsx(_2,{children:"Advanced Statistics"}),w.jsx(b2,{children:"Track how your links are performing across the web with our advanced statistics dashboard."}),w.jsxs(sl,{children:[w.jsx(ul,{children:w.jsx(cl,{src:S2,alt:"icon brand recognition"})}),w.jsx(fl,{children:"Brand Recognition"}),w.jsx(dl,{children:"Boost your brand recognition with each click. Generic links don’t mean a thing. Branded links help instil confidence in your content."})]}),w.jsx(Rf,{}),w.jsxs(sl,{$position:"middle",children:[w.jsx(ul,{children:w.jsx(cl,{src:E2,alt:"icon detailed records"})}),w.jsx(fl,{children:"Detailed Records"}),w.jsx(dl,{children:"Gain insights into who is clicking your links. Knowing when and where people engage with your content helps inform better decisions."})]}),w.jsx(Rf,{}),w.jsxs(sl,{$position:"low",children:[w.jsx(ul,{children:w.jsx(cl,{src:C2,alt:"icon fully customizable"})}),w.jsx(fl,{children:"Fully Customizable"}),w.jsx(dl,{children:"Improve brand awareness and content discoverability through customizable links, supercharging audience engagement."})]})]}),O2=()=>w.jsxs(w.Fragment,{children:[w.jsx(Xy,{}),w.jsxs("main",{children:[w.jsx(r2,{}),w.jsx(x2,{}),w.jsx(N2,{}),w.jsx(Ov,{})]}),w.jsx(Hv,{})]});pl.createRoot(document.getElementById("root")).render(w.jsx(Gt.StrictMode,{children:w.jsx(O2,{})}));
